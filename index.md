	...
	<body style='margin:0px; display: block; background: hsla(0, 0%, 0%, 1);'>
		<div id="containAll" style='margin:0px;width:100%; height: 100%; font-size: 0; display: inline-block; position: relative; background: hsla(0, 0%, 92%, 0);'>
			...
			<div id="MainBlock2" style='margin:0px;width:92%; height: 100%;overflow: hidden;position: relative; z-index: 1;display: inline-block; '>
				...
				<div id="play-Info-QuarantineH" style='margin:0px;width:100%; height:3.5%; position: relative; z-index: 1;display: inline-block; color: hsla(190, 0%, 70%, 1); font-family: Source Sans Pro;'>
					...
					<div id="resetButtonH" style="width: 15%; height: 100%; position: relative; z-index: 1;display: inline-block; overflow: hidden;">
		...
		function handleLayout1() {
			if (dmode == 'landscape') {
				...
				document.getElementById('maintitle').innerHTML = "<font style='font-weight: bold; Source Sans Pro; font-size: 1.7vmax; vertical-align: bottom;'>Simulación interactiva de una Epidemia </font><br/><font style='font-family: Source Sans Pro; font-size: 0.9vmax; vertical-align: bottom;'>basada en el <a href='https://prajwalsouza.github.io/Experiments/Epidemic-Simulation.html' style='text-decoration: none; cursor: pointer;' target='_blank'>código de Prajwal D'Souza <a href='https://www.youtube.com/watch?v=gxAaO2rsdIs' style='text-decoration: none; cursor: pointer;' target='_blank'><font style='color: hsla(197, 100%, 50%, 1);'>'3Blue1Brown'</font></a><br/><font style='font-size: 0.9vmax'>Traducido al español de la versión original de Prajwal D'Souza, código disponible en <a href='https://prajwalsouza.github.io/Experiments/Epidemic-Simulation.html' style='text-decoration: none; cursor: pointer;' target='_blank'><font style='color: hsla(280, 100%, 70%, 1);'>prajwalsouza.github.io</font></a></font></font></a>"
		...
		parameterData[0] = {name: 'infectionRadius', div: 'Radio de infección &nbsp&nbsp @@@',initValue: 0.1, max: 0.4, min: 0.01, step: 0.001, color: '10, 100%, 63%', transform: 'parseFloat(#paraValue#)', requiresReset: false, runFAtEnd: ''}
		...
		parameterData[4] = {name: 'socialDistancingFactorA', div: 'Factor de distanciamiento social &nbsp&nbsp @@@',initValue: 0, max: 1, min: 0, step: 0.01, color: '40, 100%, 50%', transform: 'parseFloat(#paraValue#)', requiresReset: false, runFAtEnd: 'boundaryForceC = linearValue(0, 1, 0.1, 2,simulationParameters.socialDistancingFactorA)'}
		...
		parameterData[7] = {name: 'quarantineAfter', div: 'Cuarentena luego de @@@ días de infección',initValue: 10, max: 100, min: 1, step: 1, color: '10, 100%, 63%', transform: 'parseInt(#paraValue#)', requiresReset: false, runFAtEnd: ''}
		parameterData[8] = {name: 'startQ', div: 'Habilitación de la zona de cuarentena @@@ días después del comienzo de la epidemia',initValue: 2, max: 100, min: 0, step: 1, color: '10, 100%, 63%', transform: 'parseInt(#paraValue#)', requiresReset: false, runFAtEnd: ''}
		parameterData[9] = {name: 'probabilityOfNoSymptoms', div: "@@@% de los infectados son asintomáticos, luego, no hacen cuarentena.", initValue: 2, max: 100, min: 0, step: 0.1, color: '58, 100%, 50%', transform: 'parseFloat(#paraValue#)/100', requiresReset: false, runFAtEnd: ''}
		...
		parameterData[13] = {name: 'infectNCommunitiesInitially', div: " @@@ comunidades infectadas inicialmente.", initValue: 2, max: 9, min: 1, step: 1, color: '76, 100%, 50%', transform: 'parseInt(#paraValue#)', requiresReset: true, runFAtEnd: ''}
		...
		function updatePlotGraph() {
			...
			options = {}
			options.text = infectedV.toFixed(1) + '% infectados'
		...
		graphToQMap['simpleCase&Q'] = ['simpleCase', 'simpleCaseGraphG', 'simpleCaseGraphH', 'simpleCaseGraph&QH', 'Caso Simple con Cuarentena']

		graphToQMap['centralLocationQuarantineCase'] = ['centralLocationCase', 'centralLocationCaseG', 'centralLocationCaseGraphH', 'centralLocationQuarantineCaseGraphH', 'Caso con un Punto de Aglomeración y Cuarentena']
		graphToQMap['centralLocationCase'] = ['centralLocationQuarantineCase', 'centralLocationQuarantineCaseGraph', 'centralLocationQuarantineCaseGraphH', 'centralLocationCaseGraphH', 'Caso con un Punto de Aglomeración']

		graphToQMap['communitiesQuarantineCase'] = ['communitiesCase', 'communitiesCaseGraph', 'communitiesCaseGraphH', 'communitiesQuarantineCaseGraphH', 'Caso Interacción entre Comunidades con Cuarentena']
		graphToQMap['communitiesCase'] = ['communitiesQuarantineCase', 'communitiesQuarantineCaseGraph', 'communitiesQuarantineCaseGraphH', 'communitiesCaseGraphH', 'Caso Interacción entre Comunidades']
